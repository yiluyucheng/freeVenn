...
vlist4 <- list(groupA=sample(1:100, 80), groupB=sample(50:150, 70), groupC=sample(1:100, 60), groupC=sample(40:200, 60))
...
p6 <- freeVenn(vlist, weighted=TRUE, Optimize=TRUE, linewidth=1.2, alpha=0) +
    scale_color_manual(values=c('#ff70a6', '#70d6ff', '#ffd670'))
    
p7 <- freeVenn(vlist2)   
p8 <- freeVenn(vlist2, weighted=TRUE, linewidth=0)  
p9 <- freeVenn(vlist4, alpha=0.3)    
